...
import io.miage.intanet.config.audit.AuditEventConverter;
import io.miage.intanet.domain.PersistentAuditEvent;
...
import static io.miage.intanet.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
